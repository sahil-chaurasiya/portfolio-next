...
const mainProjects = [
  ...
  {
    id: 'akansh-jain',
    title: 'Natural Cosmetic Surgery Centre',
    subtitle: 'Dr. Aakansh Jain — Clinic Website & Admin CMS',
    date: '2026',
    status: 'complete',
    description:
      'Full-stack MERN rebuild of a cosmetic surgery clinic website with a custom admin panel covering every content block — services, before/after gallery, testimonials, blog, team, pricing, and form submissions. JWT auth and Cloudinary-backed image management.',
  ...
  },
  {
    ...
    status: 'complete',
    description:
      'Full-stack MERN event platform with a public site and a real admin panel — 15 content types (speakers, sponsors, workshops, competitions, gallery, blog, and more), role-based Users & Roles, a Cloudinary media library, form-submission review with CSV export, and per-year "Previous Years" pages.',
    tech: ['React', 'Vite', 'Node.js', 'Express.js', 'MongoDB', 'JWT', 'Cloudinary'],
    link: '#',
    featured: false,
    accentColor: '#eab308',
  ...
  },
  {
    id: 'abhilekh',
    title: 'Dr. Abhilekh',
    subtitle: 'Consultant Urologist & Renal Transplant Surgeon',
    date: '2026',
    status: 'complete',
    description:
      'Production-grade single-page medical practice website built with Next.js 15 and TypeScript. Appointment booking with MongoDB persistence and Nodemailer email notifications, form validation with React Hook Form + Zod, and polished Framer Motion / GSAP interactions.',
    tech: ['Next.js', 'TypeScript', 'React', 'Tailwind CSS', 'Framer Motion', 'MongoDB', 'Nodemailer'],
    link: '#',
    featured: false,
    accentColor: '#14b8a6',
    number: '12',
  },
  {
    ...
    status: 'complete',
    description:
      'Full MERN-stack fashion e-commerce platform with a separate storefront and admin panel. Redux-driven cart & checkout, Razorpay and Stripe payments, Cloudinary product imagery, and full inventory/order management from the admin dashboard.',
    tech: ['React', 'Redux', 'Node.js', 'Express.js', 'MongoDB', 'Razorpay', 'Stripe', 'Cloudinary'],
  ...
  {
    id: 'tofly-accountant',
    title: 'ToFly Accountant',
    subtitle: 'Revenue Management PWA — Private',
    date: '2026',
    status: 'complete',
    description:
      'Revenue management Progressive Web App built for a digital marketing agency\'s internal finance operations — client & collections tracking, salary register, expense categorization, an EMI tracker, monthly P&L accounting, and exportable reports. Private internal tool.',
    tech: ['React', 'Node.js', 'Express.js', 'MongoDB', 'PWA', 'Docker'],
    link: '#',
    featured: false,
    accentColor: '#64748b',
    number: '14',
